...
- **Scope matters**: run-wise q-values (`Q.Value`) and global q-values (`Global.Q.Value`)
...
- **Stability matters**: stringent cutoffs can enter a *granular regime* where only a few decoys
