  ...
  headline_tbl |>
    dplyr::mutate(
      ...
      status = dplyr::case_when(
        grepl("⚠️", paste(flag_Dalpha, flag_CV, flag_Dwin, flag_IPE, flag_FDR, flag_equalchance)) ~ "⚠️ Review needed",
        grepl("⚠", paste(flag_Dalpha, flag_CV, flag_Dwin, flag_IPE, flag_FDR, flag_equalchance)) ~ "⚠ Caution",
        TRUE ~ "✓ Valid"
      ),
